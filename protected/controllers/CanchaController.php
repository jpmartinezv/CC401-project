...
class CanchaController extends Controller
{
	...
	{
		$model=new Cancha('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cancha']))
			$model->attributes=$_GET['Cancha'];
	...
	{
		$model=Cancha::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Cancha $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cancha-form')
		{
