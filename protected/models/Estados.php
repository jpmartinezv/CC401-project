...
class Estados extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipo, ref, descripcion', 'required'),
			array('ref', 'numerical', 'integerOnly'=>true),
			array('tipo, descripcion', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, tipo, ref, descripcion', 'safe', 'on'=>'search'),
		);
	}
